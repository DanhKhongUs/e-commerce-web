  ...
  return (
    <div className="shadow-md rounded-md mt-10 max-w-screen-xl mx-auto p-6 grid grid-cols-1 md:grid-cols-2 gap-8">
      ...
      <div className="border border-gray-300 p-6 rounded-lg bg-white shadow-sm">
        ...
        <button
          onClick={handleOrder}
          className="mt-12 w-full bg-[#c30069] text-white hover:bg-[#a10056] py-3 rounded font-semibold transition duration-200"
        >
          ĐẶT HÀNG
        </button>
        ...
        <div className="mt-4 text-center">
          <Link
            href="/cart"
            className="inline-block bg-[#c30069] text-white hover:bg-[#a10056] px-6 py-2 rounded"
          >
